...
public class DanhSachThietBiUser {
    ...
    public DanhSachThietBiUser(int id_thiet_bi, String ten_thiet_bi, String thong_so, String ten_thuong_hieu, int so_luong, String mo_ta, String ten_phan_loai, String ten_trang_thaii, String ten_don_vi_tinh) {
